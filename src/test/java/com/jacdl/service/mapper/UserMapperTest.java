...
import com.jacdl.domain.Authority;
...
class UserMapperTest {
    ...
    void testUserToUserDTO() {
        ...
        assertThat(convertedUserDto.getAuthorities()).containsExactly(AuthoritiesConstants.CLIENT);
    }
    ...
    void testUserDTOtoUser() {
        ...
        assertThat(convertedUser.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.CLIENT);
    }
    ...
    void userDTOToUserMapWithAuthoritiesStringShouldReturnUserWithAuthorities() {
        ...
        assertThat(convertedUser.getAuthorities().iterator().next().getName()).isEqualTo(AuthoritiesConstants.CLIENT);
    }
