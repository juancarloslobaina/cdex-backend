...
import static com.jacdl.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().balance(DEFAULT_BALANCE);
        // Add required entity
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().balance(UPDATED_BALANCE);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.balance(UPDATED_BALANCE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.balance(UPDATED_BALANCE);
