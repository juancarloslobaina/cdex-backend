...
import com.jacdl.config.Constants;
import com.jacdl.domain.User;
import com.jacdl.repository.AuthorityRepository;
import com.jacdl.repository.UserRepository;
import com.jacdl.security.AuthoritiesConstants;
import com.jacdl.service.UserService;
import com.jacdl.service.dto.AdminUserDTO;
import com.jacdl.service.dto.PasswordChangeDTO;
import com.jacdl.web.rest.vm.KeyAndPasswordVM;
import com.jacdl.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.orElseThrow().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.CLIENT).orElseThrow());
