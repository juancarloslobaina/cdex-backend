...
public class ProviderAsserts {
    ...
    public static void assertProviderUpdatableRelationshipsEquals(Provider expected, Provider actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getClients()).as("check clients").isEqualTo(actual.getClients()))
            .satisfies(e -> assertThat(e.getDeliveries()).as("check deliveries").isEqualTo(actual.getDeliveries()));
    }
}
